        ...
        @endif
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#">Laporan Evaluasi</a></li>
					</ol>
                </div>
                <!-- row -->
                 <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="/opt/cetak/laporan/evaluasi" target="_blank" method="POST" data-parsley-validate>
                                    @csrf
                                    <div class="mb-3 row">
                                        <label class="form-label">Triwulan :</label>
                                        <select class="input-default  form-control" name="triwulan" id="triwulan" required>
